...
import com.innocent.ghostleg.databinding.FragmentGhostLegResultBinding

class GhostLegResultFragment: DialogFragment() {
    private lateinit var binding: FragmentGhostLegResultBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentGhostLegResultBinding.inflate(inflater, container, false)
    ...
    override fun onDismiss(dialog: DialogInterface?) {
        ...
        listener?.onCloseGhostLegResult()
    }

    fun setListener(listener: GhostLegResultListener): GhostLegResultFragment {
